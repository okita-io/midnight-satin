...
export function NovelCard({ novel, variant = "default", fill = false, className = "" }: NovelCardProps) {
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col justify-center flex-1 min-w-0">
          <h3 className="font-display font-semibold italic text-lg xs:text-xl text-text-main truncate pr-2 mb-1 group-hover:text-primary transition-colors">
            {novel.title}
          </h3>
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col justify-center flex-1 min-w-0 py-1">
          <h3 className="font-display font-semibold italic text-xl text-text-main mb-1 group-hover:text-primary transition-colors line-clamp-2">
            {novel.title}
          </h3>
  ...
  return (
    ...
    >
      ...
      <h3 className="font-display font-semibold italic text-base text-white leading-tight mb-1 truncate group-hover:text-primary transition-colors">
        {novel.title}
      </h3>
